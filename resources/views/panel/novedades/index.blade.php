      ...
      <tbody>
        @foreach($novedades as $novedad)
          <tr class="border-b hover:bg-gray-50">
            ...
            <td class="py-2 px-4">
            <a href="{{route('novedades.show', $novedad->id)}}" class="bg-green-500 hover:underline rounded h-[30px] w-[100px] flex items-center justify-center mt-3 text-white">Ver</a>
            <a href="{{route('novedades.edit', $novedad->id)}}" class="bg-blue-500 hover:underline rounded h-[30px] w-[100px] flex items-center justify-center mt-3 text-white">Editar</a>
