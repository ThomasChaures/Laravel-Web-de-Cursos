<section class="bg-gray-100 py-12 sm:py-16 md:py-20 mt-10">
    <div class="container mx-auto px-4">
        <h2 class="text-2xl sm:text-3xl font-semibold text-center mb-6 sm:mb-8">Preguntas Frecuentes</h2>

        <div class="max-w-2xl mx-auto space-y-4">
            <!-- Pregunta 1 -->
            <div x-data="{ open: false }" class="bg-white p-4 sm:p-5 md:p-6 rounded-lg shadow-lg">
                <div @click="open = !open" class="cursor-pointer flex justify-between items-center">
                    <h3 class="text-base sm:text-lg font-medium">¿Cómo me inscribo en un curso?</h3>
                    <i :class="open ? 'fa-solid fa-minus text-1xl' : 'fa-solid fa-plus text-blue-500 text-1xl'"></i>
                </div>
                <div x-show="open" class="mt-2 text-gray-600 text-sm sm:text-base" x-transition>
            ...
            <div x-data="{ open: false }" class="bg-white p-4 sm:p-5 md:p-6 rounded-lg shadow-lg">
                <div @click="open = !open" class="cursor-pointer flex justify-between items-center">
                    <h3 class="text-base sm:text-lg font-medium">¿Puedo acceder a los cursos desde cualquier dispositivo?</h3>
                    <i :class="open ? 'fa-solid fa-minus text-1xl' : 'fa-solid fa-plus text-blue-500 text-1xl'"></i>
                </div>
                <div x-show="open" class="mt-2 text-gray-600 text-sm sm:text-base" x-transition>
            ...
            <div x-data="{ open: false }" class="bg-white p-4 sm:p-5 md:p-6 rounded-lg shadow-lg">
                <div @click="open = !open" class="cursor-pointer flex justify-between items-center">
                    <h3 class="text-base sm:text-lg font-medium">¿Cuánto tiempo tengo acceso a los cursos?</h3>
                    <i :class="open ? 'fa-solid fa-minus text-1xl' : 'fa-solid fa-plus text-blue-500 text-1xl'"></i>
                </div>
                <div x-show="open" class="mt-2 text-gray-600 text-sm sm:text-base" x-transition>
            ...
            <div x-data="{ open: false }" class="bg-white p-4 sm:p-5 md:p-6 rounded-lg shadow-lg">
                <div @click="open = !open" class="cursor-pointer flex justify-between items-center">
                    <h3 class="text-base sm:text-lg font-medium">¿Los cursos tienen certificación?</h3>
                    <i :class="open ? 'fa-solid fa-minus text-1xl' : 'fa-solid fa-plus text-blue-500 text-1xl'"></i>
                </div>
                <div x-show="open" class="mt-2 text-gray-600 text-sm sm:text-base" x-transition>
