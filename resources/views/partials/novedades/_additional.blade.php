<!-- <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div class="bg-white p-4 rounded-lg shadow-lg">
        <h4 class="text-xl font-semibold mb-2">Excelente Recursos</h4>
        <p class="text-gray-600">Accede a miles de recursos para tus estudios.</p>
        <a href="#" class="text-blue-500 hover:underline mt-2">Leer más</a>
    </div>
    <div class="bg-white p-4 rounded-lg shadow-lg">
        <h4 class="text-xl font-semibold mb-2">Facilidades de Aprendizaje</h4>
